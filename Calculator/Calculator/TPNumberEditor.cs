...
{
    public sealed class TPNumberEditor : TAEditor 
    {
		...
		readonly Regex ZeroPNumber = new Regex("^-?(0+|.?0+|0+.(0+)?)$");
        ...
        public TPNumberEditor() 
        {
            ...
            Precision = new TNumber(2);
        }
        public TPNumberEditor(string str, TNumber not, TNumber pre) 
        {
        ...
        public TPNumberEditor(double num, TNumber not, TNumber pre) 
        {
            if (not < 2 || not > 16 || pre < 0 || pre > 10) 
            {
                number = "0";
        ...
        public TPNumberEditor(string str) 
        {
            Notation = new TNumber(10);
            Precision = new TNumber(2);
            number = new TPNumber(str, Notation, Precision).ToString();
        ...
        {
            var editor = obj as TPNumberEditor;
            return editor != null &&
